...
import { SPEECH_RECOGNITION_START } from "../utilities/constants";
...
function SpeechRecognitionComponent() {
  ...
  useEffect(() => {
    ...
    recognition.lang = language === 'EN' ? 'es-EN' : 'en-US';
  ...
  return (
    <Tooltip title={isListening ? TEXT["EN"].SPEECH_RECOGNITION_STOP : TEXT["EN"].SPEECH_RECOGNITION_START}>
