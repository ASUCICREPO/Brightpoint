...
// import firstMessageImage from '../Assets/first_message.svg';
...
//     getBotResponse(setMessageList, setProcessing, message, userData.username, userData.zipcode);  // Pass username and zipcode to the response function
...
//   const socket = new WebSocket(WEBSOCKET_API);

//   socket.onopen = () => {
//     socket.send(
//       JSON.stringify({
//         action: "query",
//         user_id: "test", // Use dynamic username from context
//         zipcode: "45786", // Use dynamic zipcode from context
//         user_query: message,
//         language : "english",
...
//     language : "english"
//   }
//   console.log("📤 Sending request:", messagePayload);
...
//     if (data && data.response_data && data.response_data.services) {
//       const { zipcode, message: mainMessage } = data.response_data;
//       const services = data.response_data.services.map(service => (
...
//           </Typography>
//           <Typography variant="body1" component="div">
//             <strong>Address:</strong> {service.details.address}, {service.details.city}, {service.details.state} {service.details.zipcode}
//           </Typography>
//           <Typography variant="body1" component="div">
//             <strong>Additional Info:</strong> {service.details.additional_information}
//           </Typography>
//         </div>
//       ));
...
//       console.log("📩 Received message:", botMessageBlock);
